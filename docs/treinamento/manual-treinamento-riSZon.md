...
| Empresarial | `/empresarial` | Convênio com empresas parceiras; **Funil** é o quadro comercial de 8 fases (da captação à implantação), **Cobranças** reúne as de todas as empresas, e **Boas-vindas** é a fila de ligação da recepção/SDR em cada empresa |
