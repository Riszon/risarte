...
| **PPR7** ✅ | **Dashboard do PPR+** + **ranking das unidades** para a Franqueadora. Todo indicador é **clicável** e abre a lista por trás do número (mesmo padrão do Dashboard do Comercial, `ppr-drill.tsx`); o crescimento tem **dois gráficos separados** — quantidade de planos e receita — porque misturar grandezas confunde a leitura. |
